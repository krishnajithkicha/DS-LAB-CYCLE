		...
		if (opt==1){
			...
			while(ch=='y'){
				...
				if (op==3){
					...
					int k;
					cin>>k;
					myCDL.insert_at_pos(pos,k);
					cout<<"Element inserted"<<endl;
					cout<<endl;
				}
				if (op==4){
					cout<<"Deleting from beginning"<<endl;
					myCDL.delete_from_beg();
					cout<<"Element deleted"<<endl;
					cout<<endl;
				}
				if (op==5){
					cout<<"Deleting from end"<<endl;
			    	myCDL.delete_from_end();
					cout<<"Element deleted"<<endl;
					cout<<endl;				
				}
				if (op==6){
